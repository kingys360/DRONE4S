...
import { BarChart3, PlayCircle, Map } from 'lucide-react';
import { motion } from 'framer-motion';

const tabs = [
  { path: '/dashboard/overview', label: 'Overview', icon: BarChart3 },
  { path: '/dashboard/simulation', label: 'Simulation', icon: PlayCircle },
  { path: '/dashboard/map-analytics', label: 'Map Analytics', icon: Map }
];
      ...
      <div className="bg-neutral-900/50 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 py-3 overflow-x-auto">
            <span className="text-sm text-neutral-400 mr-2">Dashboard /</span>
            {tabs.map((tab) => {
              const Icon = tab.icon;
